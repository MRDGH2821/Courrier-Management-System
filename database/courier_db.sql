...
CREATE TABLE `tbl_courier` (`cid` int(10) NOT NULL,
                                                                                                                                                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                                                                                                                                                          `status` varchar(20) NOT NULL,
                                                                                                                                                                                                                                                                                                                                                                                                               `comments` varchar(250) NOT NULL,
                                                                                                                                                                                                                                                                                                                                                                                                                                       `book_date` date NOT NULL,
                                                                                                                                                                                                                                                                                                                                                                                                                                                        `delivery_boy_name` text NOT NULL) ENGINE=MyISAM DEFAULT
CHARSET=latin1;
...
INSERT INTO `tbl_courier` (`cid`, `cons_no`, `ship_name`, `phone`, `s_add`, `rev_name`, `r_phone`, `r_add`, `type`, `weight`, `invice_no`, `qty`, `book_mode`, `freight`, `mode`, `pick_date`, `pick_time`, `status`, `comments`, `book_date`, `delivery_boy_name`)
VALUES (1, 'M22P7KHM', 'ABC ZZ', '020 12345', 's sd sdsd', 'XYZ K', '020 12345', 'sd sd s', 'Parcel', 20, '252525', 12, 'TBB', 240, 'Road', '29/01/2020', '12', 'Completed', 'ds ds d', '2020-01-29', ''),
...
CREATE TABLE `tbl_courier_officers` (`cid` int(10) NOT NULL,
                                                                                                                           ...
                                                                                                                           `email` varchar(100) NOT NULL,
                                                                                                                                                `ph_no` varchar(12) NOT NULL,
                                                                                                                                                                    `office` varchar(100) NOT NULL,
                                                                                                                                                                                          `reg_date` datetime NOT NULL) ENGINE=MyISAM DEFAULT
CHARSET=latin1;
...
INSERT INTO `tbl_courier_officers` (`cid`, `officer_name`, `off_pwd`, `address`, `email`, `ph_no`, `office`, `reg_date`)
VALUES (1, 'kapil', 'kapil', 'rk nagar , hyderabad', 'abc@gmail.com', '1234567890', 'Fast Courier - Jalgaon', '2020-01-30 09:25:21'),
...
CREATE TABLE `tbl_courier_track` (`id` int(10) NOT NULL,
                                               `cid` int(10) NOT NULL,
                                                             `cons_no` varchar(20) NOT NULL,
                                                                                   `current_city` varchar(100) NOT NULL,
                                                                                                               `status` varchar(30) NOT NULL,
                                                                                                                                    `comments` varchar(255) NOT NULL,
                                                                                                                                                            `bk_time` datetime NOT NULL) ENGINE=MyISAM DEFAULT
CHARSET=latin1;
...
INSERT INTO `tbl_courier_track` (`id`, `cid`, `cons_no`, `current_city`, `status`, `comments`, `bk_time`)
VALUES (1, 1, 'M22P7KHM', 'Fast Courier - Jalgaon', 'Delayed', 'Delay due to rain', '2020-01-30 10:23:04'),
...
CREATE TABLE `tbl_delivery_boy` (`cid` int(10) NOT NULL,
                                               `delivery_boy_name` varchar(40) CHARACTER
                                 SET latin1 NOT NULL,
                                            `ph_no` varchar(12) CHARACTER
                                 SET latin1 NOT NULL,
                                            `office` varchar(100) CHARACTER
                                 SET latin1 NOT NULL) ENGINE=InnoDB DEFAULT
CHARSET=utf8mb4;
...
INSERT INTO `tbl_delivery_boy` (`cid`, `delivery_boy_name`, `ph_no`, `office`)
VALUES (1, 'Raja', '8765423478', 'Fast Courier - Jalgaon');
...
CREATE TABLE `tbl_offices` (`id` int(10) NOT NULL,
                                         `off_name` varchar(100) NOT NULL,
                                                                 `address` varchar(230) NOT NULL,
                                                                                        `city` varchar(100) NOT NULL,
                                                                                                            `ph_no` varchar(20) NOT NULL,
                                                                                                                                `office_time` varchar(100) NOT NULL,
                                                                                                                                                           `contact_person` varchar(100) NOT NULL) ENGINE=MyISAM DEFAULT
CHARSET=latin1;
...
INSERT INTO `tbl_offices` (`id`, `off_name`, `address`, `city`, `ph_no`, `office_time`, `contact_person`)
VALUES (1, 'Fast Courier - Jalgaon', '290, shani peth, jalgaon', 'Jalgaon', '0257-25125', '10.00 am - 9.00 pm', 'Shammi Kapur'),
...
ALTER TABLE `tbl_courier` ADD PRIMARY KEY (`cid`);

--
-- Indexes for table `tbl_courier_officers`
--

ALTER TABLE `tbl_courier_officers` ADD PRIMARY KEY (`cid`);

--
-- Indexes for table `tbl_courier_track`
--

ALTER TABLE `tbl_courier_track` ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tbl_delivery_boy`
--

ALTER TABLE `tbl_delivery_boy` ADD PRIMARY KEY (`cid`);

--
-- Indexes for table `tbl_offices`
--

ALTER TABLE `tbl_offices` ADD PRIMARY KEY (`id`);
...
ALTER TABLE `tbl_courier` MODIFY `cid` int(10) NOT NULL AUTO_INCREMENT,
                                                        AUTO_INCREMENT=6;
...
ALTER TABLE `tbl_courier_officers` MODIFY `cid` int(10) NOT NULL AUTO_INCREMENT,
                                                                 AUTO_INCREMENT=4;
...
ALTER TABLE `tbl_courier_track` MODIFY `id` int(10) NOT NULL AUTO_INCREMENT,
                                                             AUTO_INCREMENT=6;
...
ALTER TABLE `tbl_delivery_boy` MODIFY `cid` int(10) NOT NULL AUTO_INCREMENT,
                                                             AUTO_INCREMENT=2;
...
ALTER TABLE `tbl_offices` MODIFY `id` int(10) NOT NULL AUTO_INCREMENT,
                                                       AUTO_INCREMENT=4;
